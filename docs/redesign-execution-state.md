...
| 1 · Foundation: tokens, typography, dark mode | 🟢 Complete | tokens + Motion.swift, SF Pro, dynamic dark-first palette; 123 Swift tests + Swift packaging tests green |
...
2. `swift test --package-path ui --filter ChronoframePackagingTests` — must stay green.
